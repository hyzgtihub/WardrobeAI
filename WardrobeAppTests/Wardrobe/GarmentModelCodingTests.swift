...
struct GarmentModelCodingTests {
    ...
    func encodesNewGarmentWithSnakeCaseDatePriceAndNullOptionals() throws {
        ...
        #expect(object["material"] is NSNull)
        #expect(object["style"] is NSNull)
